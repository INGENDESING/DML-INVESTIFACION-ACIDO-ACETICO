...
export const processes: Process[] = [
  ...
  },
  {
    id: 'acetica',
    name: 'Acetica',
    fullName: 'Proceso Acetica (KBR/Chiyoda)',
    developer: 'Chiyoda Corporation / KBR',
    year: 1999,
    status: 'activo',
    statusLabel: 'Heterogéneo',
    tagColor: 'green',
    catalyst: 'Rodio (Rh) inmovilizado en resina PVP',
    temperature: '160–200 °C',
    pressure: '30–60 barg',
    selectivity: '~99% (MeOH)',
    coSelectivity: '~94% (CO)',
    productivity: 'Alta (reactor bubble column)',
    waterContent: '<2%',
    energy: 'Muy bajo',
    cost: 'Competitivo (CAPEX/OPEX reducidos)',
    scale: '~363 kt/a (estándar)',
    trl: 9,
    marketShare: 'Creciente',
    description: 'Proceso innovador que utiliza un catalizador de rodio heterogéneo (sólido) inmovilizado en una resina, eliminando partes móviles (agitadores) mediante un reactor de columna de burbujas.',
    advantages: [
      'Catalizador inmovilizado (pérdida casi nula)',
      'Bajo contenido de agua (<2%) reduce costos de separación',
      'Selectividad de CO muy alta (~94%)',
      'Sin sellos mecánicos de alta presión (menor fuga)',
    ],
    disadvantages: [
      'Costos asociados a la resina polimérica',
      'Menos plantas instaladas en comparación con Cativa',
    ],
    keyFact: 'El primer proceso de carbonilación comercial verdaderamente heterogéneo (fase sólida).',
  },
  {
    id: 'ao-plus',
    name: 'AO Plus',
  ...
  },
  {
    ...
    advantages: [
      'Baja presión de operación (3-10 barg)',
      'Tecnología madura',
    ],
    disadvantages: [
  ...
  },
  {
    ...
    waterContent: 'N/A',
    energy: '50–250 MJ/kg',
    cost: '$746–1,073/ton (USD 2024)',
    scale: '<50 kt/a',
    trl: 6,
    marketShare: '<1%',
    description: 'Rutas biológicas desde biomasa, syngas o CO₂. Fermentación anaerobia con acetógenos usa gas de síntesis (syngas).',
    advantages: [
